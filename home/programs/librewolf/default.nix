    ...
    profiles = rec {
      librewolf = {
        ...
        settings = {
          ...
          "browser.newtabpage.activity-stream.telemetry.structuredIngestion.endpoint" = "https://127.0.0.1";
          ...
          "toolkit.telemetry.dap.helper.url" = "https://127.0.0.1";
          "toolkit.telemetry.dap.leader.url" = "https://127.0.0.1";
